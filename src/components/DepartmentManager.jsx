...
// //     try {
// //       const res = await axios.get(`http://super-admin-backend-two.vercel.app
// /api/superadmin/departments?streamId=${streamId}`, {
// //         headers: { Authorization: `Bearer ${token}` },
// //       });
...
// //     try {
// //       await axios.delete(`http://super-admin-backend-two.vercel.app/api/superadmin/departments/${id}`, {
// //         headers: { Authorization: `Bearer ${token}` },
// //       });
// //       fetchDepartments(selectedStreamId);
// //     } catch (err) {
